...
class SplineFitter:
    ...
    def _plot_spline(self, times_gain_masked, stripe_gains, gains_masked,
        ...
        ax.plot(times_gain_masked[~stripe_gains][1::4], gains_masked[~stripe_gains][1::4], 'bo', ms=3)
        ...
        ax.plot(times_offset_masked[~stripe_offsets][1::4], offsets_masked[~stripe_offsets][1::4], 'bo', ms=3)
