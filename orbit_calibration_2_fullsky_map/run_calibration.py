...
if __name__ == "__main__":
    ...
    orbit_file_path = "/home/users/mberkeley/wisemapper/data/output_maps/w3_days/csv_files/"#w2/csv_files/"#w4/csv_files_orbits/"#w3_days/csv_files/"  # Input files, path already exists
    ...
    coadd_map.load_orbits(month=["Jan", "Feb"])#"all")#["Feb", "Mar", "Apr", "May", "Jun", "Jul"])
