...
if __name__ == "__main__":
    ...
    zodi_file_path = "/home/users/jguerraa/AME/cal_files/W4/"#W3_new/"#_days_new/"#W3_days_mooncut/"  # Input files, path already exists
    ...
    fsm_map_file = os.path.join(output_path, "fullskymap_band4_masked.fits")
    iterations = 15
    ...
    coadd_map.load_orbits(month="Jan")#["Feb", "Mar", "Apr", "May", "Jun", "Jul"])
    coadd_map.load_fitvals(14)
