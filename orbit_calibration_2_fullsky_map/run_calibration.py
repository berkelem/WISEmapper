...
if __name__ == "__main__":
    ...
    moon_stripe_file = "/home/users/mberkeley/wisemapper/data/masks/south_mask.fits"#moon_stripe_mask_G_thick3.fits"  # Input file, already exists
    ...
    coadd_map.load_orbits(month=["Jun"])#""all")
