...
if __name__ == "__main__":
    ...
    orbit_file_path = "/home/users/mberkeley/wisemapper/data/output_maps/w3/csv_files/"#w3_days/csv_files/"  # Input files, path already exists
    zodi_file_path = "/home/users/jguerraa/AME/cal_files/W3_new/"#_days_new/"#W3_days_mooncut/"  # Input files, path already exists
    ...
    coadd_map.load_orbits(month="all")#"Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug"])
    ...
    coadd_map.add_calibrated_orbits(plot=False)
