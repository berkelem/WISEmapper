...
if __name__ == "__main__":
    ...
    orbit_file_path = "/home/users/mberkeley/wisemapper/data/output_maps/w2/csv_files/"#w4/csv_files_orbits/"#w3_days/csv_files/"  # Input files, path already exists
    zodi_file_path = "/home/users/jguerraa/AME/cal_files/W2/"#W3_new/"#_days_new/"#W3_days_mooncut/"  # Input files, path already exists
    ...
    fsm_map_file = os.path.join(output_path, "fullskymap_band2_masked.fits")
    iterations = 100

    # Initialize Coadder object for managing calibration
    coadd_map = Coadder(2, moon_stripe_file, fsm_map_file, orbit_file_path, zodi_file_path, output_path)
    coadd_map.load_orbits(month="all")#["Feb", "Mar", "Apr", "May", "Jun", "Jul"])
    # coadd_map.load_fitvals(99)
